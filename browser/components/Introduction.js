	...
	render() {
		return (
			<ReactModal isOpen={ this.state.showModal } contentLabel='Introduction to Mirror-Mirror' onRequestClose={ this.handleCloseModal } overlayClassName='modal' className='modal__content'>
				...
				<p>Get started by allowing this site to access your webcam. (If you don't see a webcam prompt, <a href='https://mirror-mirror-on-my-screen.herokuapp.com/'>try a secure connection</a>.)</p>
