	...
	render() {
		return (
			<ReactModal isOpen={ this.state.showModal } contentLabel='Introduction to Mirror-Mirror' onRequestClose={ this.handleCloseModal } overlayClassName='modal' className='modal__content'>
				...
				<p>Get started by allowing this site to access your webcam.</p>
				<p className='modal__text'>View the code for this project on <a href='https://github.com/lizzthabet/mirror-mirror'>GitHub</a>.</p>
